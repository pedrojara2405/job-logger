...
namespace Old.JobLoggerConsole
{
    ...
    //        {
    //            throw new Exception("ErrororWarningorMessagemustbespecified");
    //        }
    ...
    //        System.Data.SqlClient.SqlCommand("Insert into LogValues('" + message + "'," + t.ToString() + ")");
